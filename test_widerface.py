...
parser.add_argument('--dataset_folder', default='/home/zhy/ambacaffe/examples/MobileNet-SSD/video/tianlai/', type=str, help='dataset path')
parser.add_argument('--confidence_threshold', default=0.02, type=float, help='confidence_threshold')
parser.add_argument('--top_k', default=500, type=int, help='top_k')
parser.add_argument('--nms_threshold', default=0.4, type=float, help='nms_threshold')
parser.add_argument('--keep_top_k', default=75, type=int, help='keep_top_k')
...
if __name__ == '__main__':
    ...
    for i, img_name in enumerate(test_dataset):
        ...
        videroWrite = cv2.VideoWriter('saveVideo.mp4',fourcc,fps,size)
